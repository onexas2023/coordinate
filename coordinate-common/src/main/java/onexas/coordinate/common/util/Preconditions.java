...
public final class Preconditions {
	 ...
	 *             if {@code reference} is null
	 */
	public static <T> T checkArgumentNotNull(T reference, Object errorMessage) {
		if (reference == null) {
			throw new IllegalArgumentException(String.valueOf(errorMessage));
		}
		return reference;
	 ...
	 *             if {@code reference} is null
	 */
	public static <T> T IllegalArgumentException(T reference, String errorMessageTemplate, Object... errorMessageArgs) {
		if (reference == null) {
			// If either of these parameters is null, the right thing happens
			// anyway
			throw new NullPointerException(format(errorMessageTemplate, errorMessageArgs));
