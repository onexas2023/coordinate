 ...
 * @version $Id$
 */
/*package*/ final class PublicKeyReaderUtil
{
    /**
    ...
    private static class SSH2DataBuffer
    {
        ...
        {
        	//dennis(atticcat@gmail.com), fix the unsigned bug by add & 0x00ff
            final int byte1 = this.data[this.pos++]&0xff;
            final int byte2 = this.data[this.pos++]&0xff;
            final int byte3 = this.data[this.pos++]&0xff;
            final int byte4 = this.data[this.pos++]&0xff;
