package onexas.coordinate.web.test;
...
@TestPropertySource(locations = "classpath:coordinate-web-test.properties")
public class CoordinateWebTestBase extends CoordinateCommonTestBase{
}
